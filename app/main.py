...
@st.cache_data
def load_data():
    benin = pd.read_csv(r"C:\Users\beki\Desktop\Tnx AI courses\data\benin-malanville.csv")
    sierra_leone = pd.read_csv(r"C:\Users\beki\Desktop\Tnx AI courses\data\sierraleone-bumbuna.csv")
    togo = pd.read_csv(r"C:\Users\beki\Desktop\Tnx AI courses\data\togo-dapaong_qc.csv")
